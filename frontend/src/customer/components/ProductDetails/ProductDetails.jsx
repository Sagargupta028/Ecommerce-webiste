...
import { Box, Button, Grid, Grid2, Rating } from '@mui/material'
      ...
      <div className="pt-6">
        ...
        <section className='grid  grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
          ...
          <div className="flex flex-col item-center">
            <div className="overflow-hidden rounded-lg max-w-[30rem] max-h-[35rem] mx-auto flex justify-center items-center mb-7">
              <img
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>2345 Reviews</p>
                </div>
              </div>
              ...
              <form className="mt-10">
                ...
                <Button onClick={handleAddToCart} variant='contained' sx={{px:"2rem", py:"1rem", bgcolor:"#9155fd"}}>Add to Cart
                </Button>
              </form>
            </div>
